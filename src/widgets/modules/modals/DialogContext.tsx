...
import Dialog, { DialogProps } from "@/widgets/modules/modals/Dialog";
...
export const DialogProvider = ({ children }: DialogProviderProps) => {
  ...
  return (
    <DialogContext.Provider value={{ showDialog, closeDialog }}>
      ...
      {dialogProps.show && ReactDOM.createPortal(<Dialog onClose={closeDialog} {...dialogProps} />, document.body)}
