...
export const BoardMenuIcon = ({ className }: { className?: string }) => ( // 게시판 상세 > 수정, 삭제 icon
      ...
      <div className="relative" onBlur={handleBlur}>
        ...
        { menuOpen &&
          <div className="absolute right-0 w-30 h-22 bg-white border border-gray7 shadow-m">
            <Button type="button" name="modify" onClick={() => handleMenu('modify')} className="w-full h-11 text-black font-pretendard">수정하기</Button>
            <Button type="button" name="delete" onClick={() => handleMenu('delete')} className="w-full h-11 border-t border-gray7 text-black font-pretendard">삭제하기</Button>
          </div>
        }
