...
const tabsData = [
  {
    id: "golf",
    title: "GOLF",
    content: "라운드의 즐거움을 만끽할 수 있는 환상의 골프 코스",
    imgSrc01: "/img/main/main-about-img01.webp",
    imgSrc02: "/img/main/main-about-img02.webp",
    imgSrcMo: "/img/main/main-about-mo-img01.webp",
  },
  {
    id: "nature",
    title: "NATURE",
    content: "아름다운 바다 전망 속에서 즐기는 여유와 품격",
    imgSrc01: "/img/main/main-about-img03.webp",
    imgSrc02: "/img/main/main-about-img04.webp",
    imgSrcMo: "/img/main/main-about-mo-img02.webp",
  },
  {
    id: "life",
    title: "LIFE",
    content: "평범한 일상 속 특별한 경험과 힐링을 동시에",
    imgSrc01: "/img/main/main-about-img05.webp",
    imgSrc02: "/img/main/main-about-img06.webp",
    imgSrcMo: "/img/main/main-about-mo-img03.webp",
  },
];
...
const AboutContents = () => {
  return (
    <div className="relative flex flex-col items-start justify-center gap-7.5 lg:gap-0 lg:px-[5.21%] pt-[5%] w-full h-full text-left text-white z-[1] before:absolute before:block lg:before:hidden before:content-[''] before:w-[1px] before:h-[15%] before:left-[24px] before:bottom-0 before:bg-white">
      <div className="px-6 lg:px-0 text-white text-[22px] lg:text-4xl font-bold lg:font-semibold leading-8 lg:leading-[50px]">
        자연과 어우러진 품격 있는 라운딩
        <br />
        미켈란 골프투어
      </div>
              ...
              <div className="w-full block lg:w-auto lg:flex lg:justify-between text-white lg:gap-7.5">
                ...
                <div className="block lg:flex lg:justify-start lg:flex-col">
                  <div className="pl-6 lg:p-0">
                    ...
                    <Image
                      className="w-full lg:w-0 block lg:hidden"
                      src={tab.imgSrcMo}
                      alt=""
                      width={351}
                      height={200}
                  ...
                  <div className="mt-4 lg:mt-[21px] px-6 lg:px-0 lg:flex flex-col justify-between">
                    <div className="lg:pb-[2.5%] font-pretendard text-sm lg:text-lg font-normal leading-5 lg:leading-6">
                      {tab.content}
                    </div>
                    <div className="mt-6 lg:mt-0">
                      <Link
                        className="relative h-[22px] min-w-[130px] after:absolute after:block after:content-[''] after:left-[calc(100%_-_40px)] after:top-[49%] after:max-w-[40px] after:w-full after:h-[1px] after:bg-gold lg:hover:after:animate-hoverLine"
                        href={"/about"}
                      >
                        {" "}
                        <span className="pr-[46px] font-pretendard text-sm lg:text-lg text-gold font-medium">
                          자세히 보기
                        </span>
                      </Link>
                    </div>
