...
<div class="attr_div">
<h3 class="attr_title">Tailwind CSS 필수 디렉티브 및 함수</h3>
<h4 class="attr_title">1. Directives</h4>
...
<h5 class="attr_title">@tailwind</h5>
...
<h5 class="attr_title">구성 요소별 CSS에서 @apply 사용하기</h5>
...
<h4 class="attr_title">2. Functions</h4>
