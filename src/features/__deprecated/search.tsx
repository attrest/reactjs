...
//             총 <strong className="text-gold2">{num}건</strong>의 {text} 있습니다.
//           </p>
//           <div className="flex">
//             <Select
//               value={selectValue}
...
//             />
//             <Button
//               onClick={() => onSearch(keyword, selectValue)}
//               size="icon"
//               className="absolute top-0 right-0 bottom-0 my-auto"
//             >
//               <SearchIcon />
//             </Button>
//           </div>
...
//           <p className="font-pretendard">
//             총 <span className="font-semibold text-gold2">{num}건</span>의 {text} 있습니다.
//           </p>
//         </div>
//       </div>
//     </>
