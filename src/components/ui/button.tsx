  ...
  "inline-flex items-center justify-center whitespace-nowrap text-sm lg:text-14 font-medium ring-offset-background transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "",
        color:
          "bg-black text-white font-pretendard font-medium",
        border:
          "border border-light-gray font-pretendard font-medium",
        fill:
          "bg-gray5 text-black font-pretendard font-medium",
        underline:
          "border-b border-gray font-pretendard text-gray",
        file: 
          "bg-gray4 text-white",
      },
      size: {
